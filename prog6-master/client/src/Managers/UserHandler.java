        ...
        File file = null;
            do {
                try {
                    ...
                    System.out.print("> ");
                    String fileName = userReader.readLine();
                    if (fileName.equals("")) {
            ...
            return new RequestFile(file, file.length());
        }
            ...
            try {
                ...
                switch (processCode) {
                    case OBJECT:
                        ...
                        return new Request(userCommand[0], userCommand[1], demoLabworkToAdd);
                    case UPDATE_OBJECT:
                        DemoLabwork demoLabworkToUpdate = makeLabworkToUpdate();
                        return new Request(userCommand[0], userCommand[1], demoLabworkToUpdate);
                    case SCRIPT:
                        fileMode();
