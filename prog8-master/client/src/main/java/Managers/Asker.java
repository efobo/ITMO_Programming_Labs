...
//    private boolean fileMode;
    ...
    public Asker (BufferedReader inputReader) {
     ...
     * @throws IncorrectScriptException
     */
    public Color askEyeColor() throws IncorrectScriptException {
        Color eyeColor = null;
        String strEyeColor;
        boolean flag = true;
        ...
        while (flag) {
            try {
                System.out.println("Выберите цвет глаз: " + Color.nameList());
                System.out.print("> ");
    ...
    public boolean askQuestion (String question) throws IncorrectScriptException {
        ...
        while (flag) {
            try {
                System.out.println(question + " Ответьте yes/no.");
                System.out.println("> ");
                answer = inputReader.readLine().trim();
                if (fileMode) System.out.println(answer);
                if (!answer.equalsIgnoreCase("yes") && !answer.equalsIgnoreCase("no")) throw new NoSuchElementException();
                break;
            } catch (IOException e) {
                System.out.println("Ошибка ввода");
                if (fileMode) throw new IncorrectScriptException();
    ...
    public Asker (Scanner inputScanner) {
        this.inputScanner = inputScanner;
    }


    public void setScanner (Scanner inputScanner) {this.inputScanner = inputScanner;}


    public Scanner getinputScanner() {return inputScanner;}
     ...
     * @throws IncorrectScriptException
     */
    public String askNameS() throws IncorrectScriptException {
        String name = null;
        boolean flag = true;
        while (flag) {
            try {
     ...
     * @throws IncorrectScriptException
     */
    public Long askXcS() throws IncorrectScriptException {
        Long xc = null;
        String strXc;
        Float xcCheck;
        boolean flag = true;
        ...
        while (flag) {
            try {
                ...
                System.out.println("(число должно быть целым)");
                System.out.print("> ");
                strXc = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(strXc);
                xcCheck = Float.parseFloat(strXc);
                if (xcCheck > 547 || xcCheck % 1 != 0) throw new WrongAmountOfElementsException();
                if (xcCheck == null) throw new NullPointerException();
     ...
     * @throws IncorrectScriptException
     */
    public float askYcS() throws IncorrectScriptException {
        float yc = 0;
        String strYc;
        boolean flag = true;
        ...
        while (flag) {
            try {
                ...
                System.out.println("(число может быть не целым)");
                System.out.print("> ");
                strYc = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(strYc);
                if (strYc == "") throw new NullPointerException();
                yc = Float.parseFloat(strYc);
                flag = false;
     ...
     * @throws IncorrectScriptException
     */
    public double askMinimalPointS() throws IncorrectScriptException {
        double minimalPoint = -1;
        String strMinimalPoint;
        boolean flag = true;
        ...
        while (flag) {
            try {
                ...
                System.out.println("(число может быть не целым)");
                System.out.print("> ");
                strMinimalPoint = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(strMinimalPoint);
                if (strMinimalPoint == "") throw new NullPointerException();
                minimalPoint = Double.parseDouble(strMinimalPoint);
                if (minimalPoint <= 0) throw new WrongAmountOfElementsException();
     ...
     * @throws IncorrectScriptException
     */
    public Difficulty askDifficultyS() throws IncorrectScriptException {
        Difficulty difficulty = null;
        String strDifficulty;
        boolean flag = true;
        ...
        while (flag) {
            try {
                System.out.println("Выберите сложность: " + Difficulty.nameList());
                System.out.print("> ");
                strDifficulty = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(strDifficulty);
                if (!strDifficulty.equals("")) {
                    difficulty = Difficulty.valueOf(strDifficulty);
                }
     ...
     * @throws IncorrectScriptException
     */
    public Location askLocationS () throws IncorrectScriptException {
        Location location = null;
        boolean flag = true;
        ...
        while (flag) {
            try {
                ...
                if (answer.equalsIgnoreCase("no")) {
                    ...
                    if (answer.equalsIgnoreCase("yes")) {
                        location = new Location(askXlS(), askYlS(), askLocationNameS());
                        flag = false;
                    } else {
                        System.out.println("\"Вы можете ввести только \"yes\" или \"no\"");
                        continue;
     ...
     * @throws IncorrectScriptException
     */
    public Person askPersonS () throws IncorrectScriptException {
        Person person = null;
        boolean flag = true;
        ...
        while (flag) {
            try {
                ...
                if (answer.equalsIgnoreCase("no")) {
                    ...
                    if (answer.equalsIgnoreCase("yes")) {
                        person = new Person(askPersonNameS(), askBirthdayS(), askEyeColorS(), askHairColorS(), askLocationS());
                        flag = false;
                    } else {
                        System.out.println("Вы можете ввести только \"yes\" или \"no\"");
                        continue;
     ...
     * @throws IncorrectScriptException
     */
    public String askPersonNameS() throws IncorrectScriptException {
        String personName = null;
        boolean flag = true;
        ...
        while (flag) {
            try {
                System.out.println("Введите имя создателя");
                System.out.print("> ");
                personName = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(personName);
                if (personName.equals("")) throw new NullPointerException();
                flag = false;
            } catch (NullPointerException e) {
     ...
     * @throws IncorrectScriptException
     */
    public LocalDate askBirthdayS() throws IncorrectScriptException {
        LocalDate birthday = null;
        String strBirthday;
        boolean flag = true;
        ...
        while (flag) {
            try {
                ...
                System.out.println("Пример ввода: 2000-12-11");
                System.out.print("> ");
                strBirthday = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(strBirthday);
                if (!strBirthday.equals("")) {
                    birthday = LocalDate.parse(strBirthday);
                }
     ...
     * @throws IncorrectScriptException
     */
    public Color askEyeColorS() throws IncorrectScriptException {
        Color eyeColor = null;
        String strEyeColor;
        boolean flag = true;
        ...
        while (flag) {
            try {
                System.out.println("Выберите цвет глаз: " + Color.nameList());
                System.out.print("> ");
                strEyeColor = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(strEyeColor);
                if (strEyeColor.equals("")) throw new NullPointerException();
                eyeColor = Color.valueOf(strEyeColor);
                flag = false;
     ...
     * @throws IncorrectScriptException
     */
    public data.hair.Color askHairColorS() throws IncorrectScriptException {
        data.hair.Color hairColor = null;
        String strHairColor;
        boolean flag = true;
        ...
        while (flag) {
            try {
                System.out.println("Выберите цвет волос: " + data.hair.Color.nameList());
                System.out.print("> ");
                strHairColor = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(strHairColor);
                if (!strHairColor.equals("")) {
                    hairColor = data.hair.Color.valueOf(strHairColor);
                }
     ...
     * @throws IncorrectScriptException
     */
    public Float askXlS() throws IncorrectScriptException {
        Float xl = null;
        String strXl;
        boolean flag = true;
        ...
        while (flag) {
            try {
                System.out.println("Введите координату X местоположения ");
                System.out.print("> ");
                strXl = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(strXl);
                if (strXl.equals("")) throw new NullPointerException();
                xl = Float.parseFloat(strXl);
                flag = false;
...
//                if (fileMode) throw new IncorrectScriptException();
     ...
     * @throws IncorrectScriptException
     */
    public Double askYlS() throws IncorrectScriptException {
        Double yl = null;
        String strYl;
        boolean flag = true;
        while (flag) {
            try{
                System.out.println("Введите координату Y местоположения");
                System.out.print("> ");
                strYl = inputScanner.nextLine().trim();
                if (fileMode) System.out.println(strYl);
                if (strYl.equals("")) throw new NullPointerException();
                yl = Double.parseDouble(strYl);
                flag = false;
...
//                if (fileMode) throw new IncorrectScriptException();
     ...
     * @throws IncorrectScriptException
     */
    public String askLocationNameS () throws IncorrectScriptException {
        String locationName = null;
        boolean flag = true;
...
//                if (fileMode) throw new IncorrectScriptException();
    ...
    public boolean askQuestionS (String question) throws IncorrectScriptException {
        String answer = "";
        boolean flag = true;
        while (flag) {
            try {
